...
class OntologyExplorerPlugin(AbstractPlugin):
    ...
    """
    sgnFakeItemAdded = QtCore.Signal('QGraphicsScene', 'QGraphicsItem')
...
class OntologyExplorerWidget(QtWidgets.QWidget):
    ...
    """
    sgnItemClicked = QtCore.Signal('QGraphicsItem')
    sgnItemDoubleClicked = QtCore.Signal('QGraphicsItem')
    sgnItemRightClicked = QtCore.Signal('QGraphicsItem')
