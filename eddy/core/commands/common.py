...
class CommandItemsAdd(QtGui.QUndoCommand):
    """
...
class CommandItemsRemove(QtGui.QUndoCommand):
    """
...
class CommandComposeAxiom(QtGui.QUndoCommand):
    """
...
class CommandItemsTranslate(QtGui.QUndoCommand):
    """
...
class CommandSnapItemsToGrid(QtGui.QUndoCommand):
    """
