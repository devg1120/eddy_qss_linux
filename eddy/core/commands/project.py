...
class CommandProjectSetIRI(QtGui.QUndoCommand):
    """
...
class CommandProjectSetPrefix(QtGui.QUndoCommand):
    """
...
class CommandProjectSetVersion(QtGui.QUndoCommand):
    """
...
class CommandProjectSetProfile(QtGui.QUndoCommand):
    """
