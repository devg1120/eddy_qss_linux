...
class CommandNodeAdd(QtGui.QUndoCommand):
    """
...
class CommandNodeSetDepth(QtGui.QUndoCommand):
    """
...
class CommandNodeRezize(QtGui.QUndoCommand):
    """
...
class CommandNodeSwitchTo(QtGui.QUndoCommand):
    """
...
class CommandNodeSetMeta(QtGui.QUndoCommand):
    """
...
class CommandNodeChangeInputsOrder(QtGui.QUndoCommand):
    """
...
class CommandNodeSetBrush(QtGui.QUndoCommand):
    """
