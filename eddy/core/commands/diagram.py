...
class CommandDiagramAdd(QtGui.QUndoCommand):
    """
    Extends QtGui.QUndoCommand with facilities to add a Diagram to a Project.
    """
...
class CommandDiagramRemove(QtGui.QUndoCommand):
    """
    Extends QtGui.QUndoCommand with facilities to remove a Diagram from a Project.
    """
    def __init__(self, diagram, project):
        """
        Initialize the command.
...
class CommandDiagramRename(QtGui.QUndoCommand):
    """
    Extends QtGui.QUndoCommand with facilities to rename a Diagram.
    """
...
class CommandDiagramResize(QtGui.QUndoCommand):
    """
